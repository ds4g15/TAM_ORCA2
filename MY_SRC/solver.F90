...
CONTAINS
   ...
   SUBROUTINE solver_init( kt )
      ...
      ! 2015-02-19 - SAM: added additional dependency for ASM/OBS applications with restarts
      IF( ( .NOT. lk_agrif .OR. .NOT. ln_rstart ) .AND. (.NOT.(lk_dynspg_flt.AND.ln_rstart))) THEN
